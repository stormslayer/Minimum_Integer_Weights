...
# cite: "Pivotality Measures", scott de marchi, scott.demarchi@gmail.com
...
for z in case_data_input:
    f1 = open("c:\\users\\karuthers\\dropbox\\bargaining_abm_ai\\data_input\\case_data\\"+str(z), 'r')
    ...
    for i in range(0, T):
        ...
        mean_policy = sum(map(float, dataset[i][3].split(",")))/len(dataset[i][3].split(","))
